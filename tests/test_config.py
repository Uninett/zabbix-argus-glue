...
class TestLoadConfig:
    def test_when_minimal_config_then_it_should_use_defaults(self, tmp_path):
    ...
    def test_when_full_config_then_it_should_override_defaults(self, tmp_path):
        config_file = tmp_path / "config.toml"
    ...
    def test_when_missing_argus_url_then_it_should_raise(self, tmp_path):
        config_file = tmp_path / "config.toml"
    ...
    def test_when_no_token_anywhere_then_it_should_raise(self, tmp_path, monkeypatch):
        config_file = tmp_path / "config.toml"
        config_file.write_text(
            "[argus]\nurl = 'https://argus'\n[zabbix]\nurl = 'https://zabbix'\n"
        )
    ...
    def test_when_token_in_env_then_it_should_use_env_var(self, tmp_path, monkeypatch):
        config_file = tmp_path / "config.toml"
        config_file.write_text(
            "[argus]\nurl = 'https://argus'\n[zabbix]\nurl = 'https://zabbix'\n"
        )
    ...
    def test_when_token_in_file_and_env_then_it_should_prefer_file(
